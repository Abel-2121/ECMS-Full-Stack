...
// import { useDispatch, useSelector } from 'react-redux';
// import { fetchAllElections } from '../../Js/election-slice';
// import { checkIsRegistered } from '../../Js/voterRegistration-slice';
// import { checkHasNomination } from '../../Js/nomination-slice';
// import ElectionCard from '../../components/common/ElectionCard';
// import ElectionDetailModal from '../../components/common/ElectionDetailModal';
// import RegistrationModal from '../../components/common/RegistrationModal';
// import { 
...
//         try {
//           const regResult = await dispatch(checkIsRegistered(election._id)).unwrap();
//           setRegistrationStatus(prev => ({ 
//             ...prev, 
//             [election._id]: {
//               isRegistered: regResult?.isRegistered || false,
//               voterId: regResult?.voterInfo?.voterId || null
//             }
//           }));
//         } catch (err) {
...
//         try {
//           const nomResult = await dispatch(checkHasNomination(election._id)).unwrap();
//           setNominationStatus(prev => ({ 
//             ...prev, 
//             [election._id]: {
//               hasNomination: nomResult?.hasNomination || false,
//               status: nomResult?.status || null,
//               nominationId: nomResult?.nominationId || null
//             }
//           }));
//         } catch (err) {
//           console.error(`Failed to check nomination:`, err);
//         }
//       });
//     }
...
//     setSelectedElection(null);
//     if (selectedElection) {
//       dispatch(checkIsRegistered(selectedElection._id)).then((result) => {
//         if (result.payload?.isRegistered) {
//           setRegistrationStatus(prev => ({
//             ...prev,
//             [selectedElection._id]: {
//               isRegistered: true,
//               voterId: result.payload.voterInfo?.voterId
//             }
//           }));
//         }
//       });
...
//         return;
//       }
//       navigate('/candidate/submit-nomination', { state: { preselectedElection: election } });
//       return;
//     }
...
//     if (status === 'results_published' || status === 'completed') {
//       navigate(`/voter/results/${election._id}`, { state: { election } });
//       return;
//     }
...
//     margin: '0 auto',
//     padding: 'clamp(20px, 4vw, 32px)',
//     marginTop: 'clamp(70px, 12vh, 100px)',
//     minHeight: '100vh',
//     background: '#f8fafc'
//   },
//   header: {
